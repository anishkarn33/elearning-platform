...
class BaseTestCaseMixin(object):
    ...
    def setUp(self):
        ...
        self.sally_user = User.objects.create_user(
            "sally", "sally@asdf.com", "12345678"
        )
        self.roger_user = User.objects.create_user(
            "roger", "roger@asdf.com", "2424df22"
        )
        self.james_user = User.objects.create_user(
            "james", "james@asdf.com", "2424df22"
        )
